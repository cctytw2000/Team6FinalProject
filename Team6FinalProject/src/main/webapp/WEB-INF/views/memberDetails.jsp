...
<input type="hidden" name="memberID" value="${MemberDetial.memberdetail.memberID}">
					...
					<div id="nickname">
						<label>暱稱：</label> <br><input style="border-width: 0; background-color: white" type="text"
							name="nickname" placeholder="來個新名字吧(ゝ∀･)" disabled="disabled" readonly="readonly"
							value="${MemberDetial.memberdetail.nickname}"></input> <button id="openupdate" type="button"
							onclick="openUpdate()">編輯</button>
					</div>
