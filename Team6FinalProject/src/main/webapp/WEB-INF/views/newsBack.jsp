				...
				<table border="1" style="text-align: center">
					...
					<tr>
						...
						<td><button type="button" class="btn btn-warning"
								data-toggle="modal" data-target="#ooo" onclick="updateNewsType('${newsType.newsTypeId }', '${newsType.newsTypeName }')" >更新</button>										
						<td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ooo" onclick="deleteNewsType(${newsType.newsTypeId })" >刪除</button>
					...
					<tr>
						...
						<th>刪除 <c:forEach var="gameType" items="${gameTypeList }">
								...
								<tr>
									...
									<td><button type="button" class="btn btn-warning"
											data-toggle="modal" data-target="#ooo" onclick="updateGameType('${gameType.gameTypeId }', '${gameType.gameTypeName }')" >更新</button>										
									<td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ooo" onclick="deleteGameType(${gameType.gameTypeId })" >刪除</button>
								</c:forEach>		
				</table>
			</div>
			<!-- //新增遊戲類別 -->
