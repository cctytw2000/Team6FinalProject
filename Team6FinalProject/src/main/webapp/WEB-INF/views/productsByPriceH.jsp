		...
		<section class="container">
			...
			<ul class="pagination justify-content-center" style="background-color: none">
				<c:choose>
					...
					<a class="page-link" href="<spring:url value='queryProductByHigh?currentPage=${pages.currentPage - 1}&rows=4'/>">Previous</a>
				</li>
					...
					<c:forEach begin="1" end="${pages.totalPage }" var="i">
						...
						<c:when  test="${pages.currentPage == i}">
							...
							<li class="page-item active"><a class="page-link" href="<spring:url value='queryProductByHigh?currentPage=${i}&rows=4'/>">${i}</a></li>
						</c:when>							
						
						<c:otherwise>
							<li class="page-item"><a class="page-link" href="<spring:url value='queryProductByHigh?&currentPage=${i}&rows=4'/>">${i}</a></li>
						</c:otherwise>
						</c:choose>
					</c:forEach>
				<c:choose>
					...
					<a class="page-link" href="<spring:url value='queryProductByHigh?currentPage=${pages.currentPage + 1}&rows=4'/>">Next</a>
				</li>
			</ul>
