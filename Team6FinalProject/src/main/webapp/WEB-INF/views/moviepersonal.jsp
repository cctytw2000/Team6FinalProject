...
<body
	...
	<section class="footer-top-section" style="height: 100%;">
		<div style="text-align: center" class="container">
			...
			<div class="panel col-lg-6 col-md-4">
					...
					<div class="col-lg-4 col-md-6">
						<div class="recent-game-item">
							...
							<div class="rgi-thumb set-bg">
								...
								<video class="set-video" poster="/Images/video-Bg.jpg" playsinline="playsinline" controls="controls">
									<source src=${allmovies.location_Test } type="video/mp4">
								</video>
							</div>
