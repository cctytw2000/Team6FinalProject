		...
		<section class="container">
			...
			<ul class="pagination justify-content-center" style="background-color: none">
				<c:choose>
					...
					<a class="page-link" href="<spring:url value='getProductByKeyWord?keyWord=${keyWord}&currentPage=${pages.currentPage - 1}&rows=3'/>">Previous</a>
				</li>
					...
					<c:forEach begin="1" end="${pages.totalPage }" var="i">
						...
						<c:when  test="${pages.currentPage == i}">
							...
							<li class="page-item active"><a class="page-link" href="<spring:url value='getProductByKeyWord?keyWord=${keyWord}&currentPage=${i}&rows=3'/>">${i}</a></li>
						</c:when>							
						
						<c:otherwise>
							<li class="page-item"><a class="page-link" href="<spring:url value='getProductByKeyWord?keyWord=${keyWord}&currentPage=${i}&rows=3'/>">${i}</a></li>
						</c:otherwise>
						</c:choose>
					</c:forEach>
				<c:choose>
					...
					<a class="page-link" href="<spring:url value='getProductByKeyWord?keyWord=${keyWord}&currentPage=${pages.currentPage + 1}&rows=3'/>">Next</a>
				</li>
			</ul>
