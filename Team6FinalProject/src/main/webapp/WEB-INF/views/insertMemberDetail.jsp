...
<form:form action="${pageContext.request.contextPath}/member/insertMemberInformation" method='POST' modelAttribute="MemberDetail" enctype="multipart/form-data">
		...
		<fieldset style="margin-left:40%">
			...
			<div class="div1">
				...
				<form:input id="idnumber" name="idnumber" path="idnumber" type='text'/><span id="idnumber_password"></span>
			...
			<div class="div1">
				<label class='label1'>地址:</label> <select style="margin-left:15px" id="city">
					...
					<form:input id="alladdress" size="30" name="alladdress" path="address" type='text'/><span id="address_password"></span>

			</div>


			<div class="div1">
				<form:radiobutton  id="sex" name="sex" path="sex" value="male" required="required"/><span class="sex">男</span>
				
				
				
				
				
				<form:radiobutton  id="sex" name="sex" path="sex" value="female" required="required"/><span class="sex">女</span>
			</div>
			<div class="div1">
