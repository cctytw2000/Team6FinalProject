	...
	<div class="container mt-3">
		...
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active"
				data-toggle="tab" href="#product">架上商品</a></li>
			<li class="nav-item"><a class="nav-link" data-toggle="tab"
				href="#productCancel">架下商品</a></li>
			<li class="nav-item"><a class="nav-link" data-toggle="tab"
				href="#addCategory">新增商品分類</a></li>
			<li class="nav-item"><a class="nav-link" data-toggle="tab"
				href="#addProduct">新增商品</a></li>
		</ul>
		...
		<div class="tab-content">
			...
			<div id="product" class="container tab-pane active">
				<table border="1" style="text-align: center">
					<tr>
						...
						<th>商品售價
						<th>商品分類
						<th>下架 <c:forEach var="product" items="${products }">

								<tr>
									<td>${product.game_id }
									<td><a
										href="<spring:url value='productsBack/productBack?game_id=${product.game_id }'/>">${product.name }</a>
									<td>${product.price }元
			...
			<div id="productCancel" class="container tab-pane fade">
				<table border="1" style="text-align: center">
					<tr>
						...
						<th>商品售價
						<th>商品分類
						<th>上架 <c:forEach var="c_product" items="${cancelProduct }">

								<tr>
									<td>${c_product.game_id }
									<td><a
										href="<spring:url value='productsBack/productBack?game_id=${c_product.game_id }'/>">${c_product.name }</a>
			...
			<div id="addProduct" class="container tab-pane fade">
				<form method="POST" action="productsBack/addProduct"
