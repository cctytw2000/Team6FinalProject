						...
						<div id="home" class="container tab-pane active">
							...
							<h5 style="color: white; font-size: 23px">
								...
								<div style="margin-top: 30px">
									...
									<p style="color: pink">會員註冊日期:
										${member.registeredtime.replace(".0","")}</p>
							...
							<h5 style="color: white; font-size: 23px">
								...
								<div style="margin-top: 30px">
									<table border="1" style="width: 100%">
										...
										<c:forEach var="imfo" varStatus="i"
											items="${member.liLoInfo }">
											<tr>
												<td>${imfo.clientIP}</td>
												<td>${imfo.type}</td>
												<td>${imfo.loginTime.replace(".0","")}</td>
